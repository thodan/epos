...
bazel build tensorflow/python/scripts:freeze_graph
bazel-bin/tensorflow/python/scripts/freeze_graph \
...
bazel build tensorflow/scripts/graph_transforms:summarize_graph
bazel-bin/tensorflow/scripts/graph_transforms/summarize_graph \
