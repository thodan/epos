...
# ==============================================================================
"""Contains the model definition for the OverFeat model.

The definition for the model was obtained from:
...
def overfeat(inputs,
             ...
             scope='overfeat',
             global_pool=False):
  """Contains the network definition for the OverFeat network.
