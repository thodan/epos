...
def resnet_v1(inputs,
  ...
  methods for specific network instantiations, obtained by selecting different
...
def resnet_v1_50(inputs,
                 ...
                 reuse=None,
                 scope='resnet_v1_50'):
  """ResNet-50 network of [1]. See resnet_v1() for arg and return description."""
...
def resnet_v1_101(inputs,
                  ...
                  reuse=None,
                  scope='resnet_v1_101'):
  """ResNet-101 network of [1]. See resnet_v1() for arg and return description."""
  depth_func = lambda d: max(int(d * depth_multiplier), min_base_depth)
  blocks = [
      resnet_v1_block('block1', base_depth=depth_func(64), num_units=3,
                      stride=2),
...
def resnet_v1_152(inputs,
                  ...
                  reuse=None,
                  scope='resnet_v1_152'):
  """ResNet-152 network of [1]. See resnet_v1() for arg and return description."""
  depth_func = lambda d: max(int(d * depth_multiplier), min_base_depth)
  blocks = [
      resnet_v1_block('block1', base_depth=depth_func(64), num_units=3,
                      stride=2),
...
def resnet_v1_200(inputs,
                  ...
                  reuse=None,
                  scope='resnet_v1_200'):
  """ResNet-200 network of [2]. See resnet_v1() for arg and return description."""
  depth_func = lambda d: max(int(d * depth_multiplier), min_base_depth)
  blocks = [
      resnet_v1_block('block1', base_depth=depth_func(64), num_units=3,
                      stride=2),
