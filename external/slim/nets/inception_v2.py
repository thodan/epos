...
# ==============================================================================
"""Contains the definition for inception v2 classification model."""
...
def inception_v2_base(inputs,
  ...
  Constructs an Inception v2 model from inputs to the given final endpoint.
  This method can construct the model up to the layer inception(5b) as
  described in http://arxiv.org/abs/1502.03167.

  Args:
    inputs: a tensor of shape [batch_size, height, width, channels].
    final_endpoint: specifies the endpoint to construct the model up to. It
...
def inception_v2(inputs,
  ...
  Constructs an Inception v2 model for classification as described in
  http://arxiv.org/abs/1502.03167.

  The default image size used to train this model is 224x224.
  ...
  Args:
    ...
    reuse: whether or not the model and its variables should be reused. To be
