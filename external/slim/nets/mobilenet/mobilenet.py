...
def mobilenet_base(  # pylint: disable=invalid-name
  ...
  Constructs a model from inputs to the given final endpoint. By default
  the model is constructed in inference mode. To create model
  ...
  Args:
    ...
    is_training: How to setup batch_norm and other ops. Note: most of the time
      ...
      (The model will be built in inference mode). If this is set to None,
  ...
  with _scope_all(scope, default_scope='Mobilenet'), \
    ...
    # current model layer. This allows us to invoke atrous convolution
...
def mobilenet(inputs,
  ...
  Args:
    ...
    base_only: if True will only create the base of the model (no pooling
    and no logits).
...
def training_scope(is_training=True,
  ...
  Usage:
     ...
     # the model created will be trainble with dropout/batch norm
