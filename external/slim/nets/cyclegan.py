...
def cyclegan_generator_resnet(images,
                              ...
                              is_training=False):
  """Defines the cyclegan resnet model architecture.

  As closely as possible following
  https://github.com/junyanz/CycleGAN/blob/master/models/architectures.lua#L232

  FYI: This model requires input height and width to be divisible by 4 in
  ...
  Args:
    ...
    arg_scope_fn: Function to create the global arg_scope for the model.
    ...
    tanh_linear_slope: Slope of the linear function to add to the tanh over the
      logits.
    is_training: Whether the model is created in training mode or inference
